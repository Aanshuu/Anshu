...
const Navbar = () => {
  return (
    <div className="mt-4 fixed top-0 left-0 right-0 flex justify-center items-center p-4 rounded-2xl bg-black bg-opacity-60 backdrop-blur-md shadow-md z-50 mx-auto max-w-max">
